...
>Visualization one(maybe average compexity with the first 6 categories which contain the most games)
...
newFull_gb %>%
  ...
  geom_histogram(binwidth = 20, fill = "steelblue", position = "identity", alpha = 0.4) + 
